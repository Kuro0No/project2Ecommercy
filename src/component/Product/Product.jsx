    ...
    return <div className="product-container d-flex">
        ...
        <div className="product col-9">
            <div className="row">
                ...
                <div className="mt-4">
                    <Pagination currentPage={currentPage}  productsPerPage={productsPerPage} handleNext={handleNext} paginate={paginate} handlePre={handlePre} totalProducts={products.length} />
                </div>
            </div>
        </div>
    </div>;
